...
<body>
    <div id="page">
        ...
        <!-- Content Start -->
        <div id="content">
            <h2>Form Tambah Member</h2><hr>
            <form method="post" action="<?php echo site_url('member/simpan');?>">
                <div>
                    <label>Kode Member</label>
                    <input type="text" name="kode_member" required></input>
                </div>
                <div>
                    <label>Nama Member</label>
                    <input type="text" name="nama_member" required></input>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="nomor_telepon" required=""></input>
                </div>
                <div>
                    <label>Alamat Email</label>
                    <input type="text" name="alamat_email" required></input>
                </div>
                <div>
                    <label>Alamat Rumah</label>
                    <input type="text" name="alamat_rumah" required></input>
                </div>
                <div>
                    <label>Tanggal Bergabung</label>
                    <input type="date" name="tanggal_gabung" required></input>
                </div>
                <div>
